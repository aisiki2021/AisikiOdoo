...
class SaleOrderLine(models.Model):
    ...
    def _prepare_invoice_line(self, **optional_values):
        ...
        vals["agent_ids"] = [
            (0, 0, {"agent_id": x.agent_id.id, "commission_id": x.commission_id.id}) for x in self.agent_ids
        ]
        return vals
    ...
    def _compute_amount(self):
        for line in self:
            ...
            line.amount = line._get_commission_amount(
                line.commission_id, order_line.price_subtotal, order_line.product_id, order_line.product_uom_qty,
            )
